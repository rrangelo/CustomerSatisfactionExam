...
public class CustomerControllerUnitTest extends ControllerUnitTestConfig {
    ...
    public void testCreateSuccess() throws Exception {
        Mockito.doNothing()
                .when(service)
                .create(Mockito.any(CustomerCreateCustomerRequestBean.class));
        mvc.perform(
    ...
    public void testCreateException() throws Exception {
        Mockito.doThrow(CustomerResponseException.class)
                .when(service)
                .create(Mockito.any(CustomerCreateCustomerRequestBean.class));
        mvc.perform(
                MockMvcRequestBuilders.post(ENDPOINT)
    ...
    public void testFindSuccess() throws Exception {
        Mockito.doReturn(
                ...
                .find(Mockito.any(CustomerFindCustomerRequestBean.class));
        mvc.perform(
    ...
    public void testUpdateSuccess() throws Exception {
        Mockito.doNothing()
                .when(service)
                .update(Mockito.any(CustomerUpdateCustomerRequestBean.class));
        mvc.perform(
